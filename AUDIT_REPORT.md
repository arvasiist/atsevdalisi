...
| R3 | Yarış Motoru | Low | ✅ **KISMEN DÜZELTİLDİ VE GERÇEK CI'DA DOĞRULANDI** (commit `f65db23`, CI #125) — Current Form artık `race_entries` geçmişinden gerçekten türetiliyor (`deriveFormFromRecentResults`); Track Fit/Carried Weight/Temperament/Draw/gerçek Jockey (yeni tablo/sistem gerektirdiklerinden) hâlâ nötr placeholder, bilinçli olarak Master Plan Phase B/C'ye bırakıldı |
