...
**Durum özeti (2026-09-19 itibarıyla):** Madde 1-7 ve 9'un TAMAMI ile madde 8'in T1 kısmı kapatıldı, gerçek CI'da doğrulandı (bkz. `claude/hizli-bitirme-plani.md` proje dokümanındaki detaylı kronoloji). G1 ve DOC1 (Low severity, ayrı bölümlerde) de bu turda kapatıldı. **Hâlâ AÇIK olan gerçek bulgular:** T2'nin `.tsx` component test kısmı, T3 (100+ yarış denge/adalet testi), F1 (mobil responsive), F2 (WebSocket, bilinçli PLANNED), R2 (tam alan replay), R3 (davranış hattının yarısı hâlâ placeholder), ve PvP'nin E1 ile aynı yapısal desendeki (ama mali riski olmayan) transaction ayrımı.
