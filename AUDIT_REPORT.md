...
| F1 | Frontend | Medium | ✅ **DÜZELTİLDİ** — tablet (768px+) + dar telefon (≤430px) breakpoint'leri eklendi, `RaceHud` taşma bug'ı `min()`/`clamp()` ile giderildi, tüm etkileşimli düğmeler ≥44px'e çıkarıldı (commit push bekliyor) |
